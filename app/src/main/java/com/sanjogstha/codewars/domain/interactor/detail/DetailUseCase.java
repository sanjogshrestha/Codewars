 ...
 */
public class DetailUseCase extends ObservableUseCase<ChallengeDetailDTO, String> {
    private final DetailRepository repository;

    @Inject
    public DetailUseCase(SchedulerProvider schedulerProvider,
    ...
    public Observable<ChallengeDetailDTO> buildUseCase(final String slug) {
        return repository.getDetailChallenges(slug);
    }
}
